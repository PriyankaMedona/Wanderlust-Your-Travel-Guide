...
<head>
  ...
  <title>Wanderlust - Travel World</title>
...
<body id="top" style="background-color:white;">
  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <a href="#">
        <h1 class="logo" style="font-family: Lucida Handwriting, cursive;">Wanderlust</h1>
      </a>
      ...
      <nav class="navbar">
        ...
        <ul class="navbar-list">
          ...
          <li>
            <a href="#" class="navbar-link">Guides</a>
          </li>
          ...
          <li>
            <a href="#" class="navbar-link">Highlights</a>
          </li>
          ...
          <li>
            <a href="#" class="navbar-link">Complaint</a>
          </li>

          <li>
            <a href="C:\xampp1\htdocs\wanderlust\calculate.py" class="navbar-link">Expenses</a>
          </li>
    ...
    <div class="container">
      ...
      <div class="footer-top">
        ...
        <div class="footer-list">
          ...
          <p class="footer-list-title">Get Updates on offers</p>

          <p class="newsletter-text">
            For the latest deals and tips and offers subscribe here !!
          </p>
      ...
      <div class="footer-bottom">
        ...
        <p class="copyright">
          &copy; 2023 <a href="#" class="copyright-link">wanderlust</a>. All Rights Reserved
        </p>
